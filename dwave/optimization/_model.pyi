...
import dwave.optimization.typing
...
class _Graph:
    ...
    def from_file(
        ...
        *,
        substitute: None | collections.abc.Mapping[str, typing.Callable[[typing.Any], typing.Any]] = None,
        ) -> _GraphSubclass: ...
...
class ArraySymbol(Symbol):
    ...
    def __add__(self, rhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Add: ...
    ...
    def __le__(self, rhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.LessEqual: ...
    def __matmul__(self, rhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.MatrixMultiply: ...
    def __mod__(self, rhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Modulus: ...
    def __mul__(self, rhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Multiply: ...
    def __neg__(self) -> symbols.Negative: ...
    def __pow__(self, exponent: int) -> ArraySymbol: ...
    def __radd__(self, lhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Add: ...
    def __rmatmul__(self, lhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.MatrixMultiply: ...
    def __rmod__(self, lhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Modulus: ...
    def __rmul__(self, lhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Multiply: ...
    def __rsub__(self, lhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Subtract: ...
    def __rtruediv__(self, lhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Divide: ...
    def __sub__(self, rhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Subtract: ...
    def __truediv__(self, rhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Divide: ...
    ...
    def ndim(self) -> int: ...
    def prod(self, *, axis: _AxisLike = None, initial: _InitialLike = _NoValue) -> symbols.Prod: ...
    ...
    def sum(self, *, axis: _AxisLike = None, initial: _InitialLike = _NoValue) -> symbols.Sum: ...

def _broadcast_shapes(
    lhs: collections.abc.Iterable[int],
    rhs: collections.abc.Iterable[int],
) -> tuple[int, ...]: ...
